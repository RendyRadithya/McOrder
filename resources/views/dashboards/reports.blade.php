    ...
    <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <div class="w-full sm:w-auto flex items-center gap-3">
                ...
                <div class="ml-2">
                    <a href="{{ route('reports.export', ['year' => $year, 'month' => $month]) }}" class="inline-flex items-center gap-2 px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">
