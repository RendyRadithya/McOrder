    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            <form method="GET" action="{{ route('vendor.reports') }}" class="flex items-end gap-3">
                ...
                <div>
                    <label class="block text-sm mb-2 invisible">.</label>
                    <button type="submit" class="px-5 py-2.5 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition font-semibold">
                        🔍 Filter
                    </button>
                </div>
                <div>
                    <label class="block text-sm mb-2 invisible">.</label>
                    <a href="{{ route('vendor.reports') }}" class="inline-block px-5 py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition font-semibold">
                        🔄 Reset
                    </a>
                </div>
            </form>
